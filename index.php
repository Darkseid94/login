        ...
        <div class="row justify-content-center pt-5 mt-5 m-1">
            <div class="col-md-6 col-sm-8 col-xl-4 col-lg-5 formulario">
                <form action="validar.php" method="POST">
                    ...
                    <div class="form-group text-center pt-3">
                        <h1 class="text-light">Fichas UTSelva Rayon</h1>
                    </div>
                    <div class="form-group mx-sm-4 pt-3">
                        <input type="email" maxlength="30" name="usuario" class="form-control" placeholder="Ingrese su Usuario" required>
                    </div>
                    ...
                    <div class="form-group mx-sm-4 text-right">
                        <span class=""><a href="registrar.php" class="olvide">Registrate</a></span>
                    </div>
                    <div class="form-group mx-sm-4 text-right">
